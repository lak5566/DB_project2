...
<body>
    ...
    <div class="mainframe">
        <div class="box1">
            <!--mainpage-->
			<div class="keyinbox">
                <form action="editpost.php" method="post" enctype="multipart/form-data" onSubmit="return InputCheck(this)">
                </br>
                <label>標題：</label>
                </br>
                <input type="text" id="title" name="title" placeholder="請輸入標題" value = "<?php echo $title?>">
                </br>
                <label>內容：</label>
                </br>
                <textarea class="large_textbox" name="article" id="article" cols="30" rows="10"><?php echo $article?></textarea>
                </br>
                <label>圖片：</label>
                </br>
