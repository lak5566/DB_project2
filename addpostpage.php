...
<body>
    ...
    <div class="mainframe">
        <div class="box1">
            <!--mainpage-->
			<div class="keyinbox">
                <form action="addpost.php" method="post" enctype="multipart/form-data" onSubmit="return InputCheck(this)">
                </br>
                <label>標題：</label>
                </br>
                ...
                <textarea class="large_textbox" name="article" id="article" cols="30" rows="10"></textarea>
                </br>
                <label>圖片：</label>
                </br>
